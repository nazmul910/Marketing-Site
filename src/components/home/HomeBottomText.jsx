...
function HomeBottomText() {
  return (
    <div className="font-[font2] flex items-center text-white justify-center gap-2 ">
      <p className=" absolute text-[3.2vw] w-[60vw] md:w-[50vw] lg:w-[17vw] right-2 md:right-10 lg:right-20 bottom-24 md:bottom-32 lg:bottom-72 lg:text-xl font-[font1] leading-relaxed">
